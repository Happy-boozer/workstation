...
class GetCaraWorker(context: Context, params: WorkerParameters) : Worker(context, params) {

    fun sending(phone_number: String): String? {
        ...
        val request = Request.Builder()
            .url("http://192.168.1.77:3000/get_cars")
            .post(formBody)
            .build()
        var body: String? = ""
    ...
    override fun doWork(): ListenableWorker.Result {
        ...
        val answer = sending(phone_number)
